...
<body>
	...
	<div class="view">
		<div style="text-align: center; margin-bottom: 40px; ">
			<h4>Add New Salt<hr></h4>
		</div>
		<div style="margin: auto; width: 400px;">
		<form  action="add_salt.php" style="width: 30%; margin-top: 20px; " method="post" enctype="multipart/form-data">
			<label for="itemname">Name</label>
			<input type="text" name="itemname" required style="margin-bottom: 20px;">
			<label for="capacity">Capacity</label>
			<input style="margin-bottom: 20px;" type="float" name="capacity" required>
			<label for="remaining">Remaining</label>
			<input style="margin-bottom: 20px;" type="float" name="remaining" >
